    ...
    <div class="sub1">
        <?php foreach ($listaMascotas as $mascota) { ?>
            <div class="cards">
                ...
                <button style="background-color:#4CAF50;color:white;padding:8px 16px;border:none;border-radius:4px;cursor:pointer;" onclick="navigator.clipboard.writeText(window.location.origin+'/user/php/invite_mascota.php?id_mascota=<?=$mascota['id']?>')">Copiar Invitacion</button>
